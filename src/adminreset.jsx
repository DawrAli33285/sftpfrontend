...
// ── All sub-components OUTSIDE parent ────────────────────────────────────
      ...
      >
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 20 }}>
          ...
          <Link to="/adminlogin" style={{ textDecoration: "none", width: "100%" }}>
            <button
              style={{ ...tealBtn, width: "100%", padding: "13px 0" }}
        ...
        <div>
          ...
          <div style={{ position: "relative" }}>
            ...
            <input
              ...
              style={inputStyle("newPassword", { padding: "11px 42px 11px 40px" })}
        ...
        <div>
          ...
          <div style={{ position: "relative" }}>
            ...
            <input
              ...
              style={inputStyle("confirmPassword", { padding: "11px 42px 11px 40px" })}
